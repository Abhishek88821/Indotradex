        ...
        <div class="row align-items-md-center pb-md-5">
            <div class="col-lg-12 col-xl-12">
                <div class="foo-newsletter text-center">
                    ...
                    <span>
                        Welcome to our newsletter! Stay connected and up-to-date with the latest news, updates,<br />
        ...
        <div class="row border-0">
            <div class="col-lg-5 col-xl-5">
                <div class="foo-abt-div">
                    ...
                    <p class="pe-md-5">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
                </div>
                <div class="foo-soc-div">
            ...
            <div class="col-lg-12 col-xl-12">
                <div class="foo-soc-div">
                    <h3 class="foo-counter mt-md-4 me-md-5">
...
<div class="copyright position-relative py-md-3">
    <div class="container">
        <div class="row">
...
<!-- only mobile view start -->
 <div class="d-lg-none mobile-view d-block" >
