            ...
            <div class="col-lg-9 col-xl-9">
                <div class="navbar-div d-flex align-items-center justify-content-end">
                    ...
                    <div class="nav-div-btn position-relative ms-md-4">
                        <ul class="list-unstyled  d-md-flex d-grid align-items-md-center  ms-md-4 mb-0">
                            <li class="d-flex align-items-center">
                                <a href="javascript:void(0)"
                                   class="text-decoration-none d-flex align-items-center" role="link">
                                    <i class="ri-shopping-cart-2-line pe-2"></i>e-Store
                                </a>
                            </li>
                            <li class="d-flex align-items-center">
                                <a href="javascript:void(0)"
                                   class="text-decoration-none text-white d-flex align-items-center" role="link">
