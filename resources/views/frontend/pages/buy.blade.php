                    ...
                    <div class="profile-navbar position-relative">
                        <div class="profile-navbar-menu">
                            ...
                            <div class="profile-close position-relative d-block d-md-none" >
                                <img src="assets/img/icon/close.svg" class="img-fluid me-2" alt="Menu Icon" title="Menu"><span>Menu</span>
                            </div>
                            <ul class="list-unstyled ps-0 mb-md-4">
                                <li class="d-flex align-items-center">
                                    <a href="dashboard.html" class="text-decoration-none d-flex align-items-center" role="button" >
                                    <i class="ri-home-gear-line"></i> <span
                                        class="ms-md-2">Dashboard</span> </a> </li>
                                <li class="d-flex align-items-center">
                                    <a href="supply.html" class="text-decoration-none d-flex align-items-center" role="button" >
                                    <i class="ri-customer-service-2-line"></i><span
                                        class="ms-md-2">Supply</span> </a> </li>
                                <li class="d-flex align-items-center">
                                    <a href="buy.html" class="text-decoration-none d-flex align-items-center" role="button" >
                                    <i class="ri-store-line"></i> <span
                                        class="ms-md-2">Buy</span> </a> </li>
                                <li class="d-flex align-items-center">
                                    <a href="resources.html" class="text-decoration-none d-flex align-items-center" role="button" >
                                    <i class="ri-download-2-line"></i> <span
                                        class="ms-md-2">Resources</span> </a> </li>
                                <li class="d-flex align-items-center">
                                    <a href="call.html" class="text-decoration-none d-flex align-items-center" role="button" >
                                    <i class="ri-customer-service-line"></i> <span
                                        class="ms-md-2">Call</span> </a> </li>
                                <li class="d-flex align-items-center">
                                    <a href="meeting.html" class="text-decoration-none d-flex align-items-center" role="button" >
