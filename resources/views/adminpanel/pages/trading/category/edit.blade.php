                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            ...
                            <a href="{{ route('admin.trading.category') }}" class="btn btn-outline-primary">List</a>
                        </div>
                        @include('partials.errors')
                        <form method="POST" action="{{ route('admin.trading.category.update', ['id' => $TrandingCategory->id ]) }}"
