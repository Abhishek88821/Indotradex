                ...
                <div class="card">
                    <div class="card-body">
                        <div class="mb-2 d-flex justify-content-between">
                            ...
                            <a href="{{ route('admin.trading.category.create') }}" class="btn btn-success">Create New</a>
                        </div>
                        <div class="">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                      ...
                                      <td>
                                         ...
                                         <a href="{{ route('admin.trading.category.destroy', $item->id )}}" class="text-danger p-2"> <i class="fa-solid fa-trash"></i> </a>
                                      </td>
                                  </tr>
                                    @endforeach
                            </table>
