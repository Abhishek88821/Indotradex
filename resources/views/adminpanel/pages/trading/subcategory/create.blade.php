                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <h5 class="mb-3">Add New Trading Sub Category</h5>
                            <a href="{{ route('admin.trading.subcategory') }}" class="btn btn-outline-primary">List</a>
                        </div>
                        @include('partials.errors')
                        <form method="POST" action="{{ route('admin.trading.subcategory.store') }}"
                                ...
                                <div class="form-group mb-3 row pb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <select name="category_id" id="" required class="form-control">
                                            ...
                                            <option {{ old('category_id') == $list->id ? 'selected' : '' }} value="{{ $list->id }}">{{ $list->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group mb-3 row pb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea type="text" name="short_desc" class="form-control"
                                            placeholder="Enter Product Name Here"  >{{old('short_desc') ?? ' '}} </textarea>
                                    </div>
                                </div>
