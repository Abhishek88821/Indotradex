                        ...
                        <form method="POST" action="{{ route('slider.store') }}"
                            ...
                            <div class="card-body">
                                <div class="form-group mb-3 row pb-3">
                                    <label for="name" class="col-sm-3 text-end control-label col-form-label">Banner  {{old('image')}} </label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group mb-3 row pb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea type="text" name="desc"  class="form-control" placeholder=" Enter Description Here" style="min-height:100%">{{ old('desc')}}</textarea>
                                    </div>
                                </div>
                                <div class="form-group mb-3 row pb-3">
                                    <label for="description"
