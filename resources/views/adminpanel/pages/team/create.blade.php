                        ...
                        <form method="POST" action="{{ route('teams.store') }}"
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group mb-3 row pb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="position" class="form-control"
                                            placeholder=" Enter Name Here" value="{{old('position')}}" />
                                    </div>
                                </div>
                                ...
                                <div class="form-group mb-3 row pb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea type="text" name="about"  class="form-control" placeholder=" Enter Description Here" style="min-height:100%">{{ old('about')}}</textarea>
                                    </div>
                                </div>
                                {{-- <div class="form-group mb-3 row pb-3">
                                    <label for="description"
