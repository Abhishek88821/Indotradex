                ...
                <div class="card">
                    <div class="card-body">
                        <div class="mb-2 d-flex justify-content-between">
                            ...
                            <a href="{{ route('teams.create') }}" class="btn btn-success">Create New</a>
                            ...
                            <table id="file_export"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('teams.show',[$item->id])}}" class="text-primary">
                                                <i class="fa-solid {{ $item->status == 1 ? 'fa-toggle-on' : 'fa-toggle-off' }}"></i>
                                            </a>
                                        </td>
                                        <td class="action-cell">
                                           <a href="#" class="text-primary p-2">  <i class="fa-solid fa-eye"></i> </a>
                                            <a href="{{ route('teams.edit', [$item->id])}}" class="text-success p-2">
                                                <i class="fa-solid fa-pen-to-square"></i>
                                            </a> 
                                            <form action="{{ route('teams.destroy', $item->id) }}" method="POST" style="display: inline-block;">
                                                @csrf
                                                @method('DELETE')
