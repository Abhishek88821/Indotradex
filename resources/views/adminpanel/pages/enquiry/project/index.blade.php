                ...
                <div class="card">
                    <div class="card-body">
                        <div class="mb-2 d-flex justify-content-between">
                            <h4 class="mb-0">Project Enquiry </h4>
                            ...
                            <table id="file_export"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            {{ $item->type == 1 ? 'INVESTMENT' : ($item->type == 2 ? 'ProjectOwner' : "") }}
                                        </td>
                                        <td>
...
$(document).ready(function () {
    $('#file_export').on('click', '.view-details', function () {
        ...
        $.ajax({
    url: '{{ route("admin.project.enquiries.data") }}',
    type: 'POST',
...
$(document).ready(function () {
    $(document).on('change', '.status-dropdown', function () {
        ...
        $.ajax({
            url: '{{ route("admin.project.enquiries.status") }}',
            type: 'POST',
