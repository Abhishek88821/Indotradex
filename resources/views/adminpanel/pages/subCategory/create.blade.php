                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <h5 class="mb-3"> Create {{Str::title( $type )}} Category</h5>
                            <a href="{{ route('admin.subCategory',['type' => $type ]) }}" class="btn btn-outline-primary">List</a>
                        </div>
                        @include('partials.errors')
                        <form method="POST" action="{{ route('admin.subCategory.store',['type' => $type]) }}"
                                ...
                                <div class="form-group mb-3 row pb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="short_desc" class="form-control"
                                            placeholder="Enter Product Name Here" value="{{old('short_desc')}}" />
                                    </div>
                                </div>
                            ...
                            <div class="p-3 border-top">
                                <div class="form-group text-end">
                                    ...
                                    <a href="{{ route('admin.subCategory.store',['type' => $type]) }}"
